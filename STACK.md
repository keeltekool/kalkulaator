...
## Overview
Estonian calculator aggregator. Three calculators live: Automaks + Palgakalkulaator + Käibemaksukalkulaator. Competing with kalkulaator.ee.
...
| Testing | Vitest (225 tests, 27 golden fixtures) |
| Hosting | Vercel |
...
- `/kaibemaksukalkulaator` — VAT calculator

## Features
- Automaks calculator with exact parity to kalkulaator.ee
- Salary calculator with exact parity (100 tests, 12 golden fixtures)
- VAT calculator with exact parity (40 tests, 11 golden fixtures)
